...
export const translations = {
  en: {
    ...
    // Modified English values to avoid collision with Data Keys used for storage
    colRequested: 'Waiting for Prep',
    colProcessing: 'In Production',
    colSent: 'Dispatched',
    colFeedback: 'Results Received',

    // DATA KEYS (Canonical keys used in database/storage)
    '单晶': 'Single Crystal',
    '多晶': 'Polycrystalline',
    '微粉': 'Powder',
    '悬浮液': 'Suspension',
    ...
    // Status Data Keys (Storage keys mapped to Excel/Display values)
    '等待中': 'Waiting',
    '样品制作中': 'Processing',
    '样品已发出': 'Sent',
    '客户初步测试': 'Testing',
